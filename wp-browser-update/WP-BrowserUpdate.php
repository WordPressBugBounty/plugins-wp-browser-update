...
var $buoop = {required:{'.$browser.'},test:'.(isset($wpbu_js[1]) ? $wpbu_js[1] : '').',newwindow:'.(isset($wpbu_js[2]) ? $wpbu_js[2] : '').',style:"'.(isset($wpbu_js[3]) ? $wpbu_js[3] : '').'",insecure:'.(isset($wpbu_js[4]) ? $wpbu_js[4] : '').',unsupported:'.(isset($wpbu_js[5]) ? $wpbu_js[5] : '').',mobile:'.(isset($wpbu_js[6]) ? $wpbu_js[6] : '').',shift_page_down:'.(isset($wpbu_js[7]) ? $wpbu_js[7] : '').',api:2024.07};
...
$msie_vers = array_merge($morethan, [[126, '<=126'], [100, '<=100'], [90, '<=90'], [18, '<=18'], [16, '<=16']]);
$firefox_vers = array_merge($morethan, [[127, '<=127'], [100, '<=100'], [90, '<=90'], [80, '<=80'], [70, '<=70']]);
$opera_vers = array_merge($morethan, [[111, '<=111'], [85, '<=85'], [75, '<=75'], [65, '<=65'], [55, '<=55']]);
$safari_vers = array_merge($morethan, [[17, '<=17'], [16, '<=16'], [15, '<=15'], [14, '<=14'], [13, '<=13']]);
$google_vers = array_merge($morethan, [[126, '<=126'], [100, '<=100'], [100, '<=100'], [90, '<=90'], [80, '<=80']]);

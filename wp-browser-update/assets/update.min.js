// WPBU local runtime adapter for browser-update.org update.min.js.
// Upstream: https://browser-update.org/update.min.js
// Upstream SHA-256 on 2026-05-03: d0732d97fb1d79bb3caf374e0a26923eac41fc211ecfc450cb8f73899841acbd
// Original license: MIT Style License <browser-update.org/LICENSE.txt>
// Changes: removes fallback loading from browser-update.org; WP BrowserUpdate supplies local jsshowurl/domain.
...
window.$bu_getBrowser=$bu_.get_browser;var $buo=function(op,test){var n=window.navigator,b;op=window._buorgres=op||{};var ll=op.l||(n.languages?n.languages[0]:null)||n.language||n.browserLanguage||n.userLanguage||document.documentElement.getAttribute("lang")||"en";op.llfull=ll.replace("_","-").toLowerCase().substr(0,5);op.ll=op.llfull.substr(0,2);op.domain=op.domain!==undefined?op.domain:"";op.apiver=op.api||op.c||-1;op.jsv=$bu_.version;var required_min=(op.apiver<2018&&{i:10,f:11,o:21,s:8,c:30})||{};var vs=op.notify||op.vs||{};if(vs.e!==0)
...
var e=document.createElement("script");if(!op.jsshowurl)return;e.src=op.jsshowurl;document.body.appendChild(e);};$buo(window.$buoop);
